...
namespace Rent_to_Go_Without_relationship.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class PropertiesController : ControllerBase
    {
        private readonly Rent_to_Go_Without_relationshipContext _context;

        public PropertiesController(Rent_to_Go_Without_relationshipContext context)
        {
            _context = context;
        }
